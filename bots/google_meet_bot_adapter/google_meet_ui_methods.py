...
class GoogleMeetUIMethods:
    ...
    def find_element_by_selector(self, selector_type, selector):
        try:
            ...
            print(
                f"Unknown error occurred in find_element_by_selector. Exception type = {type(e)}"
            )
            return None
    ...
    def look_for_blocked_element(self, step):
        ...
        if cannot_join_element:
            ...
            print(
                "Google is blocking us for whatever reason, but we can retry. Raising UiGoogleBlockingUsException"
            )
    ...
    def fill_out_name_input(self):
        ...
        for attempt_to_look_for_name_input_index in range(
            ...
            try:
                ...
                print(
                    f"Could not find name input. Unknown error {e} of type {type(e)}. Raising UiCouldNotLocateElementException"
                )
                raise UiCouldNotLocateElementException(
    ...
    def click_captions_button(self):
        ...
        for attempt_to_look_for_captions_button_index in range(
            ...
            try:
                ...
                print(
                    f"Could not find captions button. Unknown error {e} of type {type(e)}. Raising UiCouldNotLocateElementException"
                )
                raise UiCouldNotLocateElementException(
