# Generated by Django 5.1.2 on 2025-08-03 03:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_calendar_id', models.CharField(blank=True, max_length=512, null=True)),
                ('last_sync_at', models.DateTimeField(blank=True, null=True)),
                ('last_successful_sync_at', models.DateTimeField(blank=True, null=True)),
                ('synced_until', models.BigIntegerField(blank=True, null=True)),
