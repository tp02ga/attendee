...
class TeamsBotAdapter(BotAdapter, TeamsUIMethods):
    def __init__(
        self,
        *,
        display_name,
    ...
    def init_driver(self):
        ...
        with open(os.path.join(current_dir, "teams_chromedriver_payload.js"), "r") as file:
    ...
    def init(self):
        ...
        # Trying making it smaller so Teams sends smaller video frames
