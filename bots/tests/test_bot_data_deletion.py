...
class TestBotDataDeletion(TestCase):
    def setUp(self):
        ...
        self.utterance1 = Utterance.objects.create(
            recording=self.recording1,
            participant=self.participant1,
            audio_blob=b"test audio 1",
            timestamp_ms=1000,
            duration_ms=500
        )
        
        self.utterance2 = Utterance.objects.create(
            recording=self.recording2,
            participant=self.participant2,
            audio_blob=b"test audio 2",
            timestamp_ms=1000,
            duration_ms=500
        )
    ...
    def test_delete_data_multiple_recordings(self):
        ...
        recording1b = Recording.objects.create(
            bot=self.bot1,
            recording_type=1,
            transcription_type=1,
            state=RecordingStates.COMPLETE
        ...
        utterance1b = Utterance.objects.create(
            recording=recording1b,
            participant=self.participant1,
            audio_blob=b"test audio 1b",
            timestamp_ms=2000,
            duration_ms=500
        )
