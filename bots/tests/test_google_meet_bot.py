...
from .mock_data import MockVideoFrame, MockF32AudioFrame
    ...
    def test_google_meet_bot_can_join_meeting_and_record_audio_and_video(
        ...
        def simulate_join_flow():
            ...
            participants_data = {
                "type": "UsersUpdate",
                "newUsers": [
                    {"deviceId": "user1", "fullName": "Test User", "humanized_status": "in_meeting"}
                ],
                "removedUsers": [],
                "updatedUsers": []
            }
            controller.adapter.participants_info["user1"] = {
                "deviceId": "user1", 
                "fullName": "Test User", 
                "active": True
            }
