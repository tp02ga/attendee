...
class BotEventSubTypes(models.IntegerChoices):
    ...
    COULD_NOT_JOIN_MEETING_LOGIN_REQUIRED = 18, "Bot could not join meeting - Login required. See https://docs.attendee.dev/guides/signed-in-bots for how to resolve."
