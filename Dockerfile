...
# This is a workaround to avoid the crash. When we can upgrade to Ubuntu 24.04, we can remove this. The root cause is
# libproxy. The version in Ubuntu 22.04 is bad but the version in Ubuntu 24.04 is good.
ENV NO_PROXY=-
