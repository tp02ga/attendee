...
class CreditTransactionForm(forms.Form):
    amount = forms.DecimalField(label='Credit Amount', max_digits=10, decimal_places=2,
                               help_text='Positive values add credits, negative values subtract credits')
...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    def add_credit_transaction_button(self, obj):
        ...
        return format_html(
            '<a class="button" href="{}">Add Credit Transaction</a>',
            url
        )
