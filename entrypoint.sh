...
# create a virtual audio sink (speaker)
echo "Creating virtual audio sink (speaker): ";
pactl load-module module-virtual-sink sink_name=VirtualSpeaker format=s16le
